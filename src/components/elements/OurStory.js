...
import awards_01 from "../../assets/img/awards-01.svg";
import awards_02 from "../../assets/img/awards-02.svg";
import image_2 from "../../assets/img/color-shape/image-2.svg";
import feature_3 from "../../assets/img/color-shape/feature-3.svg";
import Background from "../../assets/img/shape/dot-dot-wave-shape.svg";

class OurStory extends React.Component{
    render() {
        return(
            <section className="our-story-section pt-60 pb-120" style= {{ backgroundImage: `url(${Background})`}} >
                        ...
                        <div className="col-lg-5 col-md-12 order-lg-1">
                            <div className="section-heading sticky-sidebar">
                                ...
                                <div className="mt-4">
                                    ...
                                    <img src={awards_01} alt="awards" className="me-4 img-fluid" />
                                        <img src={awards_02} alt="awards" className="img-fluid" />
                                </div>
                            </div>
                        </div>
                            ...
                            <div className="story-grid-wrapper position-relative">
                                ...
                                <ul className="position-absolute animate-element parallax-element shape-service d-none d-lg-block">
                                    <li className="layer" data-depth="0.02">
                                        <img src={image_2} alt="shape" className="img-fluid position-absolute color-shape-2 z-5" />
                                    </li>
                                    <li className="layer" data-depth="0.03">
                                        <img src={feature_3} alt="shape" className="img-fluid position-absolute color-shape-3" />
                                    </li>
                                </ul>
