...
import widget from "../../assets/img/screen/widget-11.png"
                    ...
                    <div className="row justify-content-lg-between align-items-center">
                        <div className="col-lg-5 col-12">
                            <div className="why-choose-content">
                                ...
                                <p>Distinctively promote parallel vortals with ubiquitous e-markets. Proactively
                                    benchmark turnkey optimize next-generation strategic leadership without resource
                                    sucking ideas.</p>
                                ...
                                <a href="about-us.html" className="read-more-link text-decoration-none">Know More About
                                    Us <i className="far fa-arrow-right ms-2"></i></a>
                            </div>
                        </div>
                        <div className="col-lg-6 col-12">
                            <div className="feature-img-holder mt-4 mt-lg-0 mt-xl-0">
                                <img src={widget} className="img-fluid" alt="feature" />
                            </div>
                        </div>
                    </div>
                </div>
